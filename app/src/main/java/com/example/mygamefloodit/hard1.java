...
public class hard1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button easyButton = findViewById(R.id.button_hard4);
        Button normalButton = findViewById(R.id.button_hard5);
        Button hardButton = findViewById(R.id.button_hard6);

        easyButton.setOnClickListener(v -> {
            Intent intent = new Intent(hard1.this, MainActivity.class);
            intent.putExtra("numColors", 6);
            intent.putExtra("maxTurns", 65);
