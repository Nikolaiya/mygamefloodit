...
import androidx.appcompat.app.AppCompatDelegate;
    public class easy1 extends AppCompatActivity {
            ...
            protected void onCreate(Bundle savedInstanceState) {
                ...
                Button easyButton = findViewById(R.id.button_easy4);
                Button normalButton = findViewById(R.id.button_easy5);
                Button hardButton = findViewById(R.id.button_easy6);

                easyButton.setOnClickListener(v -> {
                    Intent intent = new Intent(easy1.this, MainActivity.class);
