...
public class hard3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button easyButton = findViewById(R.id.button_hard11);
        Button normalButton = findViewById(R.id.button_hard12);
        Button hardButton = findViewById(R.id.button_hard13);

        easyButton.setOnClickListener(v -> {
            Intent intent = new Intent(hard3.this, MainActivity.class);
            intent.putExtra("numColors", 6);
            intent.putExtra("maxTurns", 50);
