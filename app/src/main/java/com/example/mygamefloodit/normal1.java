...
public class normal1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button easyButton = findViewById(R.id.button_normal4);
        Button normalButton = findViewById(R.id.button_normal5);
        Button hardButton = findViewById(R.id.button_normal6);

        easyButton.setOnClickListener(v -> {
            Intent intent = new Intent(normal1.this, MainActivity.class);
            intent.putExtra("numColors", 5);
            intent.putExtra("maxTurns", 35);
